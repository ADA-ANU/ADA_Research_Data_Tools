...
```{r}
# # Please enter the original variable names  (for gender, education, age, and state) and name the new deidentified variables that will be produced by this syntax.
...
###################################################################################################################################################
# 
# file_path <- 'Z:/assda/publish/ANU/Archivists/Weifan/ANUpoll data/ANUPoll 43 100007/02_ANUPoll_43_Data_File_100007.sav'     #data to confidentialise
# 
...
#Note 1. the program will automatically recode -99 to -1 and 90 to 99 as system missing.
#Note 2. preprocessing may be required as well. For instance, group continuous age variable to categorical
#Note 3. In ANUpoll, ADAID 01459: it also had a variable p_further_ed
#Note 4. usually state variable does not have NA values, then We add NA catagory to the State.

####################### Draft for group 2 or 3 values into one category [codes all defined missing as *].
